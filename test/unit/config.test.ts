/**
 * Pure configuration helpers and constants.
 * Ported from the sidecar suite; the standalone config module exposes the same
 * surface, so these stay behaviour-for-behaviour identical.
